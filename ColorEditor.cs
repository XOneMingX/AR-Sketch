...
public class ColorEditor : MonoBehaviour, IMixedRealityTouchHandler
{
    ...
    /// </summary>
    void SummonColorPicker(GameObject container)
    {
    ...
    private void ApplyColor()
    {
        ...
        {
            TargetObjectMesh.sharedMaterial.color = CustomColor;
        }
